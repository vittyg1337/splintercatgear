...
| `retailer_module_view` | At least 25% of a product-record retailer module enters the viewport | `content_id`, `product_category`, `source_page`, `destination_markets`, `affiliate_status`, `link_version` | Supplies the eligible-view denominator for retailer outbound rate | No |
